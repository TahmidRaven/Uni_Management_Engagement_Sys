...
header("location:http:my_profile.php");
}else{
...
<section class="menu-section">
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="admin/">Faculty Login </a></li>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                <h4 class="page-head-line" style="color: white;">Please Login To Enter into Advising Panel as Student</h4>
