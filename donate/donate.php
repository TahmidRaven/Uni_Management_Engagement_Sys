	...
	<div class="row">
		<div class="col-md-6 offset-md-3 form-container">
          ...
          <!-- Error Messages -->
              ...
              <input type="text" name="contact_no" value="" placeholder="+008801****" class="form-control" required pattern="^\d{11}$" title="11 numeric characters only" maxlength="11">
            </div><!--End form-group-->
					<!-- <div class="form-group">
              <label for="city">City</label>
              <select name="city" id="city" class="form-control demo-default" required>
	<option value="">-- Select --</option><optgroup title="DHAKA" label="&raquo; DHAKA"></optgroup><option value="mothijil" >mothijil</option><option value="puran dhaka" >puran dhaka</option><option value="uttara" >uttara</option><option value="Mirpur" >Mirpur</option><option value="gazipur" >gazipur</option><option value="badda" >badda</option><option value="savar" >savar</option><option value="gulshan" >gulshan</option><option value="Banani" >Banani</option></select>
            </div>city end -->
            <div class="form-group">
            ...
            <div class="form-inline">
              ...
              <span style="margin-left:10px;"><b>I am agree to donate my blood</b></span>
            </div><!--End form-group-->
